...
<style>
    ...
    .container { max-width: 700px; margin: auto; background: white; padding: 25px; border-radius: 12px; box-shadow: 0px 4px 15px rgba(0,0,0,0.08); }
    h2, h3 { color: #2c3e50; }
...
<div class="container">
    ...
    <form method="POST">
        ...
        <input type="text" name="username" placeholder="اكتب اسم المستخدم هنا..." required>
        <label>كلمة المرور:</label>
        <input type="password" name="password" placeholder="اكتب 000" required>
...
<div class="container">
    ...
    <form method="POST">
        ...
        <input type="password" name="new_password" placeholder="اكتب كلمة السر الجديدة..." required>
        <button type="submit">حفظ كلمة السر الجديدة</button>
    </form>
</div>
'''
...
<div class="container">
    ...
    <form method="POST">
        ...
        <textarea name="message" rows="3" placeholder="اكتب تفاصيل الاجتماع أو التعميم هنا..." required></textarea>
    ...
    {% for ann in announcements %}
        <div class="card">
            <strong>📢 {{ ann.title }}</strong> (إلى: <em>{{ ann.target }}</em>)
            <p>{{ ann.message }}</p>
        </div>
    {% else %}
        <p>لا توجد تعاميم مرسلة حتى الآن.</p>
    {% endfor %}
</div>
'''
...
<div class="container">
    ...
    <form method="POST">
        ...
        <h4 style="color: #0275d8; margin-top: 15px;">حدد حصص الأسبوع كاملة:</h4>
        <label>السبت:</label>
        <input type="text" name="sat" placeholder="مثال: رياضيات...">
        <label>الأحد:</label>
        <input type="text" name="sun" placeholder="مثال: فيزياء...">
        <label>الإثنين:</label>
        <input type="text" name="mon" placeholder="مثال: فراغ...">
        <label>الثلاثاء:</label>
        <input type="text" name="tue" placeholder="مثال: تاريخ...">
        <label>الأربعاء:</label>
        <input type="text" name="wed" placeholder="مثال: لغة إنجليزية...">
        <label>الخميس:</label>
        <input type="text" name="thu" placeholder="مثال: مراجعة...">
        
        <button type="submit">حفظ الجدول الأسبوعي</button>
    </form>
</div>
'''
...
<div class="container">
    ...
    <h3>🔔 التعاميم والاجتماعات الموجهة إليك:</h3>
    {% for ann in announcements %}
